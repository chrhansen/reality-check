...
#define OAUTH_SCOPE_PARAM    @"r_fullprofile r_emailaddress"
...
- (void)loginWithWebView:(UIWebView *)webWiew completion:(void (^)(NSDictionary *oauthTokens, NSError *error))completion
{
    ...
    self.loadingIndicator.center = CGPointMake(self.webView.bounds.size.width / 2.0f, self.webView.bounds.size.height / 2.0f);
